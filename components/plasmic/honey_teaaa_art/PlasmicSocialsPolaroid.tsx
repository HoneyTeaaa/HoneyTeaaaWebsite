...
import sty from "./PlasmicSocialsPolaroid.module.css"; // plasmic-import: lhueAMWT6GZY/css

createPlasmicElementProxy;

export type PlasmicSocialsPolaroid__VariantMembers = {
  back2: "back2";
};
export type PlasmicSocialsPolaroid__VariantsArgs = {
  back2?: SingleBooleanChoiceArg<"back2">;
};
type VariantPropType = keyof PlasmicSocialsPolaroid__VariantsArgs;
export const PlasmicSocialsPolaroid__VariantProps = new Array<VariantPropType>(
  "back2"
);

export type PlasmicSocialsPolaroid__ArgsType = {
  projectTitle?: string;
  date2?: string;
  backHeader1?: string;
  infoPage?: string;
...
type ArgPropType = keyof PlasmicSocialsPolaroid__ArgsType;
export const PlasmicSocialsPolaroid__ArgProps = new Array<ArgPropType>(
  "projectTitle",
  "date2",
  "backHeader1",
  "infoPage",
...
export type PlasmicSocialsPolaroid__OverridesType = {
  root?: Flex__<"div">;
...
export interface DefaultSocialsPolaroidProps {
  projectTitle?: string;
  date2?: string;
  backHeader1?: string;
  infoPage?: string;
...
function PlasmicSocialsPolaroid__RenderFunc(props: {
  variants: PlasmicSocialsPolaroid__VariantsArgs;
  args: PlasmicSocialsPolaroid__ArgsType;
  overrides: PlasmicSocialsPolaroid__OverridesType;
  forNode?: string;
}) {
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox___0V8Bk, {
              [sty.freeBoxback2___0V8Bk7HKhL]: hasVariant(
                $state,
                "back2",
                "back2"
              )
      ...
      >
        ...
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__q5Q7, {
              [sty.freeBoxback2__q5Q77HKhL]: hasVariant(
                $state,
                "back2",
                "back2"
              )
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__uhYqa)}
                  displayHeight={"100%"}
          ...
          <div
            className={classNames(projectcss.all, sty.freeBox__fXn26, {
              [sty.freeBoxback2__fXn267HKhL]: hasVariant(
                $state,
                "back2",
                "back2"
              )
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicSocialsPolaroid__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicSocialsPolaroid__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicSocialsPolaroid__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSocialsPolaroid__ArgProps,
          internalVariantPropNames: PlasmicSocialsPolaroid__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSocialsPolaroid__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSocialsPolaroid";
  } else {
    func.displayName = `PlasmicSocialsPolaroid.${nodeName}`;
  }
  return func;
}

export const PlasmicSocialsPolaroid = Object.assign(
  // Top-level PlasmicSocialsPolaroid renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSocialsPolaroid
    internalVariantProps: PlasmicSocialsPolaroid__VariantProps,
    internalArgProps: PlasmicSocialsPolaroid__ArgProps
  }
);

export default PlasmicSocialsPolaroid;
/* prettier-ignore-end */
