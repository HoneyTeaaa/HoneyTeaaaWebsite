...
import Label from "../../Label"; // plasmic-import: oGiErnzBTNfA/component
import Checkbox from "../../Checkbox"; // plasmic-import: vt7lInvVpX0M/component
import Description from "../../Description"; // plasmic-import: MKPAaa8HYxns/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: pqbSBZb9VG36A9gA4GgWPg/projectcss
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: _BIGxKAKL5XW/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__rHrCk)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__xPdd5)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__tNfrS)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___4GxCy)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
