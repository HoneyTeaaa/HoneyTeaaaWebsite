...
import Button from "../../Button"; // plasmic-import: MpsyFOWcgJb-/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: 9jYfnuXxIGTf/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_G7tDEZ3f-lZE"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__ueuCv)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__yh6Jo)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__ofikk)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button__lgruR)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
